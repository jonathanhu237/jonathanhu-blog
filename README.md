...
The blog is built using the AstroPaper theme, providing a clean and minimalist design. You can learn more about the theme by checking the [link](https://github.com/satnaing/astro-paper#readme) for more details.
